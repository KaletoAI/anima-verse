...
- pose catalog: 50 entries (transferred 1:1 from the 51 curated presets,
...
for axis, expected_count, expected_default in (
        ("pose", 50, "standing"), ("expression", 8, "neutral")):
...
try:
    ...
    assert len(get_catalog("pose")) == 50, len(get_catalog("pose"))
