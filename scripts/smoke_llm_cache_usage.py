...
# reaches world.db through llm_stats.record_call; without a storage root every
# world access raises StorageNotInitialised — there is no default world any
# more, so nothing here can land in the tracked worlds/demo
