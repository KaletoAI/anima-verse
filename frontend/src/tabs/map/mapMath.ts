...
// The line STYLES and their decoration live in the shared package since
// 2026-09-09 (`packages/scene-render/src/stroke.ts`): the 3D client walks the
// same decorated centre line to grow props along a stroke. Re-exported here so
// every editor import keeps its path.
export {
  STROKE_STYLES, isStrokeStyle, strokeSeed, decorateStroke,
  MAX_DECORATED_POINTS,
} from '@anima/scene-render'
export type { StrokeStyle, StrokeDeco, DecoratedStroke } from '@anima/scene-render'
