...
`+e.fragmentShader,e.fragmentShader.includes(J)?e.fragmentShader=e.fragmentShader.replace(J,`
  ...
  ${Z}`):Q(Z)},e.customProgramCacheKey=()=>`anima-water`}function $(e,t){let n=t.material||null,r=n?.class||`matte`,i=r===`water`||r===`ice`,a={roughness:n?.roughness??(i?.08:r===`gloss`?.25:.85),metalness:n?.metalness??(i?.15:.02)};t.map?a.map=t.map:a.color=we(e,t.color??(i?n?.tint:16777215)),t.transparent&&(a.transparent=!0),t.opacity!==void 0&&(a.opacity=t.opacity),t.side!==void 0&&(a.side=t.side),t.depthWrite!==void 0&&(a.depthWrite=t.depthWrite);let o=new e.MeshStandardMaterial(a);return r===`glow`&&(o.emissive=we(e,n?.tint??16777215),o.emissiveIntensity=n?.glow??1,t.map&&(o.emissiveMap=t.map)),i&&(ye||=Se(e),o.normalMap=ye,o.normalScale=new e.Vector2(1,1),be||=xe(e),Ee(o,n,t.mask||be)),o}var De=e({CLIP_MAX_POINTS:()=>64,FIGURE_HEIGHT_M:()=>FIGURE_HEIGHT_M,MAP_RELIEF_Z_FACTOR:()=>3,MAX_DECORATED_POINTS:()=>MAX_DECORATED_POINTS,SCATTER_CELLS_MAX:()=>M,SCATTER_CELL_M:()=>64,SCATTER_CLEAR_HEIGHT_RATIO:()=>w,SCATTER_MAX_PER_CELL:()=>j,SCATTER_MAX_PER_ENTRY:()=>d,STROKE_AMPLITUDE_DEFAULT_M:()=>2,STROKE_SPACING_DEFAULT_M:()=>10,VERIFY_EPS:()=>VERIFY_EPS,WATERFALL_MIN_DROP_M:()=>1,WATERFALL_MIN_SLOPE:()=>WATERFALL_MIN_SLOPE,WATER_FLOW_FACTOR_MIN:()=>WATER_FLOW_FACTOR_MIN,WATER_FLOW_SPEED_DEFAULT_M_S:()=>_e,WATER_FLOW_SPEED_MAX_M_S:()=>2,surfaceMaterial:()=>$,updateSurfaceMaterials:()=>K});export{l as A,O as C,p as D,k as E,v as O,A as S,g as T,F as _,oe as a,te as b,M as c,C as d,y as f,N as g,m as h,le as i,b as k,j as l,D as m,$ as n,ge as o,E as p,K as r,he as s,De as t,d as u,ne as v,f as w,T as x,P as y};
//# sourceMappingURL=src-CpcrCFJn.js.map