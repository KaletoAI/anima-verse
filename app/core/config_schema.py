            ...
            "backends": {
                ...
                "fields": {
                    ...
                    "api_type": {
                        "type": "select",
                        "label": "API Typ",
                        "choices": ["a1111", "comfyui", "openai_chat", "openai_diffusion", "civitai", "together"],
                    ...
                    "num_inference_steps": {"type": "int", "label": "Inference Steps", "min": 1, "max": 200, "applicable_for": ["a1111", "comfyui", "together", "openai_diffusion"]},
                    ...
                    "timeout": {"type": "int", "label": "Timeout (s)", "default": 120, "min": 10, "max": 3600, "description": "Request-Timeout fuer die Bild-Generierung (HTTP). Bei langsamen Modellen/grossen Bildern hochsetzen. Gilt fuer together/openai_diffusion/openai_chat.", "applicable_for": ["together", "openai_diffusion", "openai_chat"]},
