...
SECTIONS = {
    ...
    "image_generation": {
        ...
        "fields": {
            ...
            "blender_lod_ratio": {"type": "float", "label": "Distance mesh detail", "default": 0.25, "min": 0.02, "max": 0.9, "description": "Target fraction of the triangle count for an automatically built distance mesh. Judged so far: 0.25 holds up well on props and characters, room dioramas want 0.5 because their detail sits in a few small areas next to large flat walls. Only affects meshes built from now on."},
