...
SECTIONS = {
    ...
    "image_generation": {
        ...
        "fields": {
            ...
            "tpose_prompt": {"type": "text", "label": "T-pose prompt (humanoid)", "placeholder": "T-pose, standing upright facing the camera, arms raised straight out to the sides at exact shoulder height, fully extended and parallel to the floor, body and arms forming the letter T, both palms turned forward toward the camera, fingers straight and slightly spread, thumbs pointing up, legs straight and slightly apart", "description": "POSE LAYER ONLY for the T-pose reference render of HUMANOID characters (input for image-to-3D/rigging chains) — placed at the START of the prompt so the pose outweighs the outfit text. Palms face the camera on purpose: image-to-3D reconstructs hands from what it sees, and the back of a hand carries far less shape information than an open palm. Framing/lighting/background come from the 'tpose' use-case style. EMPTY = built-in default."},
