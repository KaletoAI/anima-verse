...
SECTIONS = {
    ...
    "chat": {
        ...
        "fields": {
            ...
            "anti_rep_lookback": {"type": "int", "label": "Repetition lookback (turns)", "default": 6, "min": 2, "max": 20, "description": "How many of the character's recent replies are fuzzy-checked for near-duplicates to drive the reactive bump. Note for thought turns: these are journal entries, so six of them can span several days."},
        },
    },
    "memory": {
