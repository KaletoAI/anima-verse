        ...
        "sub_arrays": {
            ...
            "backends": {
                ...
                "fields": {
                    ...
                    "full_mask": {"type": "bool", "label": "Full mask", "default": True, "description": "Nur bei Category=inpaint (Map-Blend). AN = ganze Flaeche maskieren (Edit-/Gray-Fill-Modelle wie Qwen/Flux2). AUS = nur die Mitte/Zelle maskieren (Fill-Modelle wie Flux-Dev-Fill).", "applicable_for": ["openai_diffusion"]},
