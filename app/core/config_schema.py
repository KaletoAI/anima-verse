        ...
        "sub_arrays": {
            ...
            "backends": {
                ...
                "fields": {
                    ...
                    "video_endpoint": {"type": "str", "label": "Video endpoint path", "default": "/v1/videos/generations", "description": "Request path on the gateway for video generation. localai_video default '/v1/videos/generations'; openai_video default '/v1/videos' (strict OpenAI: create → poll → /content). The response is auto-detected (inline b64/url or an async job that gets polled).", "applicable_for": ["localai_video", "openai_video"]},
