        ...
        "sub_arrays": {
            ...
            "backends": {
                ...
                "fields": {
                    ...
                    "supports_negative_prompt": {"type": "bool", "label": "Supports negative prompt", "default": True, "visible_when": {"category": ["txt2img", "img2img"]}, "not_applicable_for": ["openai_mesh", "localai_video", "together_video", "openai_video"], "description": "CFG backends (SD/SDXL, A1111, Z-Image with CFG > 1) honour a separate negative prompt; distilled / guidance-free models (Z-Image Turbo, Flux, Qwen-Image) have no negative input — untick it and every negative (use-case default + negations taken out of the subject + dialog input) is folded into the positive prompt as negations (\"no fog, no trees\") instead of being dropped."},
