...
SECTIONS = {
    ...
    "image_generation": {
        ...
        "fields": {
            ...
            "tpose_back_prompt": {"type": "text", "label": "Back view prompt", "placeholder": 'back view, seen directly from behind, the back of the head and the heels toward the camera, face not visible, standing upright in T-pose, arms raised straight out to the sides at exact shoulder height, fully extended and parallel to the floor, palms facing down toward the floor, fingers straight and slightly spread apart, legs straight and slightly apart, hair tucked in front of the shoulders so the back stays visible, all garments worn closed', "description": "POSE LAYER ONLY for the extra BACK view of the T-pose reference render (enabled per character on the character editor's 3D tab). No face words here on purpose: every facial token pulls a face into the image and the model then turns the character toward the camera or paints a face onto the back of the head — the expression layer is left out entirely for this view. Framing, lighting and negatives come from the 'tpose_back' use-case style. EMPTY = built-in default."},
            "tpose_left_prompt": {"type": "text", "label": "Left profile prompt", "placeholder": "strict left side profile view, seen exactly from the character's left side, the whole body in profile facing the left edge of the frame, standing upright in T-pose, both arms raised straight out to the sides at exact shoulder height so that in this profile the near arm points straight at the camera and hides the far arm behind it, the outstretched arms appear strongly foreshortened, shoulders level, palms facing down toward the floor, legs straight and slightly apart, hair tucked behind the shoulders, all garments worn closed", "description": "POSE LAYER ONLY for the extra LEFT profile of the T-pose reference render (enabled per character on the character editor's 3D tab). The text describes what a T-pose profile actually shows — the near arm strongly foreshortened, pointing at the camera and hiding the far arm — because 'toward/away from the camera' alone made the render drop the arms forward and down. Framing, lighting and negatives come from the 'tpose_side' use-case style (shared with the right profile). EMPTY = built-in default."},
            "tpose_right_prompt": {"type": "text", "label": "Right profile prompt", "placeholder": "strict right side profile view, seen exactly from the character's right side, the whole body in profile facing the right edge of the frame, standing upright in T-pose, both arms raised straight out to the sides at exact shoulder height so that in this profile the near arm points straight at the camera and hides the far arm behind it, the outstretched arms appear strongly foreshortened, shoulders level, palms facing down toward the floor, legs straight and slightly apart, hair tucked behind the shoulders, all garments worn closed", "description": "POSE LAYER ONLY for the extra RIGHT profile of the T-pose reference render (enabled per character on the character editor's 3D tab). Same text as the left profile with the side flipped. Framing, lighting and negatives come from the 'tpose_side' use-case style. EMPTY = built-in default."},
