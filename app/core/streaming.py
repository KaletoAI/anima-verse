...
class StreamingAgent:
    ...
    def build_tool_decision_input(self, user_input: str,
        ...
        return (
            ...
            f"For an activity: one of the pose keys listed after a place (or under 'Anywhere here') in the "
            f"places block; free text only when the roleplay needs it. NEVER emit **I do <X>** with a key "
            f"marked '(with partner)' — a two-person action is started by the InteractWith tool, not by "
            f"this marker. Do NOT invent location names.\n"
