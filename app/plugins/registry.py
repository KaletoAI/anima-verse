...
class Package:
    ...
    capability_description: str = ""  # human-facing UI text (LLM descriptions address the character)
    being: str = ""               # species prompt noun: person/animal/... (scene composition)  # optional UI labels per slot
