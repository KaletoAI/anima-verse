...
Write as a narrative summary in past tense and in the third person, about {{ speaker_b }} — never in the first person ("I", "me", "my"). Do not open with a relative time word ("today", "heute", "just now"): this entry is read months later next to its date.
